...
.PHONY: run, clean
project: src/main.o src/Mandelbrot.o src/Application.o src/Timer.o
	g++ $(CFLAGS) src/main.o src/Mandelbrot.o src/Application.o src/Timer.o -o build/project -lGL -lGLEW -lglfw -lSOIL -lGLC -lsfml-graphics -lsfml-window -lsfml-system
